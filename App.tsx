    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
      {SUGGESTED_PROMPTS.map(({ title, prompt }) => (
        <button
          ...
          className="p-4 bg-zinc-100 dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800 rounded-xl text-left hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-colors"
        >
...
const ChatWelcome: React.FC<{ onPromptClick: (prompt: string) => void }> = ({ onPromptClick }) => (
    <div className="flex-grow flex items-center justify-center">
        <div className="text-center p-4">
            <div className="inline-block p-4 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl mb-6">
