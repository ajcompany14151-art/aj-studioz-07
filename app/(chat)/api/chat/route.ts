  ...
  if (attachmentsFromParts.length > 0) {
    ...
    if (imageAttachments.length > 0) {
      ...
      try {
        ...
        const imageContext = imageAttachments.map((img: any) => 
